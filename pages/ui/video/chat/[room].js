...
import Screen from '../../../../src/components/dashboard/Screen';
...
const VideoChat = ({questionaireId}) => {
    ...
    if (typeof window !== 'undefined') {
        // TODO: Validate the actual tokken here
        ...
        <>
            <FullLayout>
                <Container ref={videoContainer}>
                    <Screen questionaireId={questionaireId} isAudioMuted={isAudioMuted} isVideoMuted={isVideoMuted} toggleAudioMute={toggleAudioMute} toggleVideoMute={toggleVideoMute} disConnectCall={disConnectCall} roomID={roomID} mypeers={peers} myVideo={<StyledVideo ref={userVideo} muted autoPlay playsInline />} />
                </Container>
            </FullLayout>
        </>
    );
...
export async function getServerSideProps(context) {
    const { query } = context;
    const questionaireId = query.questionaireId || '';
